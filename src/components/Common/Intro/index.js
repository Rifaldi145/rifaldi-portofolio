...
import { fullname, JobTitle, SOCIAL_LINKS } from '../../../constants/constants';
    ...
    <>
      ...
      <div className='headerr z-50 absolute bg-MidNightBlack backdrop-blur-sm inset-y-0 h-48 top-0 flex items-center justify-center w-full flex-col px-4 gap-y-4'>
        <div className="relative w-20 h-20">
          <Image
            src="/images/rifaldi3.JPG"
            alt="Muhammad Rifaldi Judri"
            fill
        ...
        <div className='flex flex-col items-center justify-center'>
          <span className='text-gray-300 text-base font-bold break-normal'>{fullname}</span>
          <span className='text-sm text-LightGray text-center mt-2'>{JobTitle}</span>
        </div>
      </div>

      {/* middle components */}
      <div className='beech z-20 flex flex-col overflow-y-scroll pt-48 top-48 space-y-6 divide-y divide-white overflow-x-hidden no-scrollbar px-4 pb-10'>
        <Languages />
